...
const services: ServicePackage[] = [
  {
    ...
    price: "Let's talk",
    features: ["$100 for a night", "2+ photos per band member", "Shot while you play", "24hr turnaround"],
    category: "concert",
  ...
  },
  {
    ...
    price: "Let's talk",
    features: ["Concept development", "Filming", "Social media cuts"],
  ...
  },
  {
    ...
    price: "Let's talk",
    features: ["Music highlight video (3-6 mins)", "Raw footage of ceremony and speeches", "Audio Recording"],
    category: "wedding",
    ...
    <section id="services" className="py-20 bg-zinc-900/30 border-y border-zinc-800">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-serif mb-4 text-white">Services</h2>
